...
if [ ! -z $step02 ]; then
   ...
   utils/perturb_data_dir_speed.sh 0.9 $data/$train_set $data/train_1.1
   utils/perturb_data_dir_speed.sh 0.9 $data/$train_set $data/train_0.9
   ...
   # form train_vol_sp
   utils/combine_data_dir.sh $tgt/train_vol_sp $tgt/train $tgt/train_1.1 $tgt/train_0.9
