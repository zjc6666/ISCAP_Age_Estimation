...
def get_parser(parser=None, required=True):
    ...
    # accent classification parameter

    parser.add_argument('--utt2labelTrain', type=str, default=None,
                        help='Filename utt2labelTrain')
    parser.add_argument('--utt2labelDev', type=str, default=None,
                        help='Filename utt2labelDev')
    parser.add_argument('--attSize', type=int, default=512,
                        help='attSize')
    parser.add_argument('--linearSize', type=int, default=512,
                        help='linearSize')
    parser.add_argument('--nonlinearType', type=str, default='Tanh',
                        help='NonlinearType (Tanh or ReLu)')
    parser.add_argument('--lossType', type=str, default='MSE',
                        help='Loss type e.g. MSE or RMSE or MAE')
    parser.add_argument('--numClass', type=int, default=5,
                        help='number of class')
    parser.add_argument('--afa', type=float, default=0.5,
                        help='mix rate Bate(0.5, 0.5)')
    parser.add_argument('--mix-scale', type=float, default=0.15,
                        help='mix scale')

    # for encoderSpecAug
    parser.add_argument('--encoder-layer', type=int, default=3,
                        help='encoder layer')
    parser.add_argument("--resize_mode", type=str, default="PIL", help="")
    parser.add_argument("--max_time_warp", type=int, default=0, help="")
    parser.add_argument("--max_freq_width", type=int, default=26, help="")
    parser.add_argument("--n_freq_mask", type=int, default=3, help="")
    parser.add_argument("--max_time_width", type=int, default=40, help="")
    parser.add_argument("--n_time_mask", type=int, default=2, help="")
    parser.add_argument("--inplace", type=strtobool, default=True, help="")
    parser.add_argument("--replace_with_zero", type=strtobool, default=True, help="")

    # cross attention
    parser.add_argument("--squence-length", type=int, default=250, help="")

    # triple loss
    parser.add_argument("--triple-loss-weight", type=float, default=1, help="")
    
    # add x-vector as a input auxiliary features
    parser.add_argument("--xvector-feats", type=str, default="", help="")

    # add speaker aware config
    parser.add_argument("--speaker-vector", type=str, default="", help="")
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.asr.pytorch_backend.asr_train_withUtt import train
